...
export function eventToFeature(event: EventWithRelations, faculties?: string[]): EventFeature {
  ...
  return {
    ...
    properties: {
      ...
      showFrom: event.showFrom ? event.showFrom.toISOString() : undefined,
      parentPlaceIds,
    },
...
export function featureToEventData(feature: EventFeature): EventData {
  ...
  return {
    ...
    latitude,
    campusId: feature.properties.campus || null,
    startDate: new Date(feature.properties.startDate),
    endDate: new Date(feature.properties.endDate),
    showFrom: feature.properties.showFrom ? new Date(feature.properties.showFrom) : null,
  };
}
