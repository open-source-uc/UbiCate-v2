  ...
  return (
    <button
      ...
      className={`p-1 w-full cursor-pointer ${
        isDisabled
          ? "bg-surface-low cursor-not-allowed"
          : isLoading
          ? "bg-interactive-accent text-interactive-accent-foreground"
          : "bg-interactive-primary text-interactive-primary-foreground hover:bg-interactive-accent hover:text-interactive-accent-foreground"
