...
export default function NotificationBarDesktop() {
  ...
  return (
    <section className="fixed top-0 right-0 w-full z-50 py-2 px-4 flex flex-col tablet:flex-row desktop:items-start desktop:justify-end gap-2 pointer-events-none">
