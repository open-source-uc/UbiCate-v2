  ...
  return (
    <>
      ...
      <div className="flex h-screen">
        {/* Sidebar principal */}
        <section
          className={`bg-brown-dark/95 backdrop-blur-sm text-white-ubi flex flex-col z-40 h-full transition-all duration-200 pb-4 ${isOpen ? "w-54" : "w-20"
            }`}
        >
        ...
        <section
          className={`shadow-lg h-full overflow-hidden bg-brown-dark/95 backdrop-blur-sm text-white-ubi transition-all duration-200 border-l-1 border-brown-light ${activeSubSidebar !== null ? "w-96 opacity-100 p-2" : "w-0 opacity-0 p-0"
            }`}
        >
