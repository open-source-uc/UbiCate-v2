...
const digitalDevelopmentTeams: { team: string; lead?: TeamMemberProps; members: TeamMemberProps[] }[] = [
  {
    ...
    lead: {
      ...
      photo: "/contributors/apiyservicios/fernando_amulek.jpg",
    },
    members: [
      {
        ...
        area: "Subdirección de Proyectos y Soluciones Digitales",
        role: "Consultor",
        photo: "/contributors/apiyservicios/maximiliano_flores.png",
      },
      {
        name: "Ivan Nunez",
        area: "Subdirección de Proyectos y Soluciones Digitales",
        role: "Consultor",
        photo: "/contributors/apiyservicios/ivan_nunez.png",
      },
      {
        name: "Fabian Salazar",
        area: "Subdirección de Proyectos y Soluciones Digitales",
        role: "Consultor",
        photo: "/contributors/apiyservicios/fabian_salazar.png",
      },
    ],
  },
];
