    ...
    navigator.geolocation.getCurrentPosition(
        ({ coords }) => {
            currentData = {
                ...
                position: {
                    type: 'Feature',
                    properties: { identifier: 'user_loc', name: 'Usuario', information: '', categories: ['user'], campus: '', faculties: '', floors: [], needApproval: false },
 ...
 */
export function useUbication(
    options: Options = { cardinalPoints: 8, updateInterval: 1_500 }
